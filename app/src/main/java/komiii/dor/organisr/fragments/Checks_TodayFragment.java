...
public class Checks_TodayFragment extends Fragment {

        public Checks_TodayFragment() { }
        ...
        public void refresh(View v){
            ...
            try {
                ResultSet rs = BoilerFunctions.query(getContext(), BoilerEnum.todosTodayQuery.getContent());
                while(rs.next()) {
                    ids.add(rs.getInt(1));
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            View v = inflater.inflate(R.layout.fragment_todos_today, container, false);
            refresh(v);
            return v;
        }
